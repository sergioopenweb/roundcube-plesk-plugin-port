...
class libcalendaring extends rcube_plugin
{
    ...
    /**
     * Resolve a stylesheet path with a larry fallback for manual installs.
     */
    ...
    public function startup($args)
    {
        if ($this->rc->output && $this->rc->output->type == 'html') {
            ...
            $this->include_stylesheet($this->stylesheet_path('libcal.css', 'skins/larry/libcal.css'));
        ...
        if (($args['task'] ?? null) == 'mail') {
            if (($args['action'] ?? null) == 'show' || ($args['action'] ?? null) == 'preview') {
